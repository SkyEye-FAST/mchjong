...
These are prerelease dependencies. Update a pin only after API review and
installed/absent-profile verification. [Rooms](ROOMS.md#maid-players) covers player operation;
