...
Source: `kansai_mizuno/atlas/mizuno.png` (1500 x 1000).
...
Source: `kanto_fluffystuff/atlas/default.png` (1500 x 1000).
...
The supplied directory names are reversed relative to the in-game presets.
