...
class TablePresentationTest {
    ...
    @Test void closerDefaultViewKeepsTheNearCornerTilesInsideAFourByThreeViewport() {
        ...
        assertTrue(settings.cameraDistance < 2.5);
        assertTrue(settings.cameraHeight < 2.2);
        double pitch = Math.atan2(settings.cameraHeight - TableGeometry.FELT_Y, settings.cameraDistance);
