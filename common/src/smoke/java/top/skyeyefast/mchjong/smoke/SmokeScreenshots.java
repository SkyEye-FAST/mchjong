...
public final class SmokeScreenshots {
    ...
    public static void grab(File output, String name, RenderTarget target, int scale, Consumer<Component> callback) {
        if (REQUESTED.contains(name)) Screenshot.grab(output, name, target, scale, callback);
    }
}
