...
public final class TableSettings {
    ...
    public Identifier riichiStickPreset = RiichiStickPresets.DEFAULT;
    public Identifier voicePreset = VoicePresets.DEFAULT;
    ...
    public static TableSettings load(Path path) throws IOException {
        ...
        settings.riichiStickPreset = Identifier.parse(config.getOrElse("riichiStickPreset", settings.riichiStickPreset.toString()));
        settings.voicePreset = Identifier.parse(config.getOrElse("voicePreset", settings.voicePreset.toString()));
