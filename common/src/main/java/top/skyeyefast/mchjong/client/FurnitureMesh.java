...
public final class FurnitureMesh {
    ...
    public static void stool(PoseStack pose, MultiBufferSource buffers, int light, FurnitureWood wood, DyeColor color) {
        ...
        FurnitureShape.bevel(pose, felt, -.359375f, .52f, -.359375f, .359375f, top - .001f, .359375f, .04f, tint(color, 1), light);
        for (int x : new int[]{-1, 1}) for (int z : new int[]{-1, 1})
    ...
    public static void customStick(PoseStack pose, MultiBufferSource buffers, int light, Identifier texture) {
        stick(pose, buffers.getBuffer(net.minecraft.client.renderer.rendertype.RenderTypes.entityCutout(texture)), light, 0, 32);
    }
