...
/** REI view of the shared Create workshop displays. */
public final class CreateWorkshopRei {
    ...
    public static void registerCategories(me.shedaniel.rei.api.client.registry.category.CategoryRegistry registry) {
        registry.add(category());
        registry.addWorkstations(CATEGORY, EntryStacks.of(com.simibubi.create.AllBlocks.MECHANICAL_PRESS.asItem()),
            EntryStacks.of(com.simibubi.create.AllBlocks.MECHANICAL_MIXER.asItem()),
            EntryStacks.of(com.simibubi.create.AllBlocks.DEPLOYER.asItem()),
            EntryStacks.of(com.simibubi.create.AllBlocks.MECHANICAL_SAW.asItem()));
    }
    ...
    private static final class Category implements DisplayCategory<Display> {
        ...
        @Override public Renderer getIcon() { return EntryStacks.of(CreateCompat.PRINTING_PLATE); }
